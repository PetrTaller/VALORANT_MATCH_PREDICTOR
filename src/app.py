...
models = {
    ...
    "XGBoost": "src/models/xgboost_classifier.pkl",
    "Sequential": "src/models/sequential_model.h5"
}

def load_ml_model(model_name):
    if model_name == "Sequential":
        #return load_model(models[model_name])  # Uncomment when Sequential model is available
        return None  # Placeholder for Sequential model loading logic
    else:
